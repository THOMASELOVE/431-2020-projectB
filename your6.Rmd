...
3. Cleaning the Data 
    ...
    - The last subsection of Section 3 should be a **Codebook** which lists all of the variables you will use in your analyses (plus the subject identifying code) and no other variables. 
        ...
        - For categorical variables, list the levels in the codebook. If any of those levels are "don't know" or "did not respond" or "unknown" I would drop those cases in the cleaning process, treating those as missing values.
